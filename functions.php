...
if(is_admin()){
	require_once PEXETO_CLASSES_PATH.'class-pexeto-notice.php';
	...
	require_once(PEXETO_LIB_PATH.'utils/class-envato-market-github.php');
}
...
require_once PEXETO_CLASSES_PATH.'class-pexeto-recaptcha.php';
