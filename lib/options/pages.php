...
array(
	...
	array(
		...
		'id' => PEXETO_SHORTNAME.'_captcha_v2_site_key',
		'type' => 'text',
		'desc' => 'In order to use the reCAPTCHA service you need to register site and 
			secret keys - you can do it on this page:<br/>
			https://www.google.com/recaptcha/admin#list <br/>
	...
	array(
		...
		'id' => PEXETO_SHORTNAME.'_captcha_v2_secret_key',
		'type' => 'text',
		'desc' => 'In order to use the reCAPTCHA service you need to register site 
			and secret keys - you can do it on this page:<br/>
			https://www.google.com/recaptcha/admin#list <br/>
	...
	array(
		'name' => '(Deprecated) reCAPTCHA Public Key',
		'id' => PEXETO_SHORTNAME.'_captcha_public_key',
		'type' => 'text',
		'desc' => 'This option has been deprecated. Please use the reCAPTCHA Site Key
		option instead.'
	),

	array(
		'name' => '(Deprecated) reCAPTCHA Private Key',
		'id' => PEXETO_SHORTNAME.'_captcha_private_key',
		'type' => 'text',
		'desc' => 'This option has been deprecated. Please use the reCAPTCHA Secret Key
		option instead.'
	),

	array(
		'name' => 'reCAPTCHA Widget Theme',
		'id' => PEXETO_SHORTNAME.'_captcha_v2_theme',
		'type' => 'select',
		'options' => array( 
	...
	array(
		'name' => 'reCAPTCHA Language Code',
		'id' => PEXETO_SHORTNAME.'_captcha_v2_language_code',
		'type' => 'text',
		'desc' => '(Optional) If left empty, the reCaptcha widget will automatically detect the user\'s language.
		To explicitly set a language to be loaded, enter the corresponding language code - here is the full codes reference: 
		https://developers.google.com/recaptcha/docs/language'
	),

	array(
		'name' => 'Wrong CAPTCHA message',
		'id' => PEXETO_SHORTNAME.'_wrong_captcha_error_text_v2',
		'type' => 'text',
		'std' => 'Failed to verify that you are not a robot. Please check the checkbox below.'
	),
