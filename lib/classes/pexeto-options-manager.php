...
class PexetoOptionsManager{
	...
	protected function format_before_option_title($option_id){
		return sprintf('<div class="option option-id-%s"><h4>', $option_id);
	}
	...
	public function print_text_field($value){
		echo $this->format_before_option_title($value['id']).$value['name'].$this->after_option_title;
	...
	public function print_custom($value){
		echo $this->format_before_option_title($value['id']).$value['name'].$this->after_option_title.'<br/><br/><br/>';
